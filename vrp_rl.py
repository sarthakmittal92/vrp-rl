...
class Simulate:
    ...
    def render(self, save_path):
        ...
        plt.close('all')
        num_plots = 2 if int(np.sqrt(len(self.tour_indices))) >= 3 else 1
    ...
    def train(self, args):
        ...
        for epoch in range(20):
            ...
            for batch_idx, batch in enumerate(train_loader):
                ...
                save_path = os.path.join(save_dir, 'partial-actor.pt')
                torch.save(self.actor.state_dict(), save_path)
                save_path = os.path.join(save_dir, 'partial-critic.pt')
...
def trainVRP(args):
    ...
    LOAD_DICT = {3: 10, 10: 20, 20: 30, 50: 40, 80: 45, 100: 50, 200: 60}
    MAX_DEMAND = 9
    STATIC_SIZE = 2 # (x, y)
...
args.checkpoint = os.path.join('vrp', '50', '19_19_19.692923' + os.path.sep)
